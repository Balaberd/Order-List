import { getCheckedOrdersIDLength } from "features/OrdersList/store/selectors";
...
function OrderListTableFooter({ filteredOrdersLength, ordersOnPageLength }) {
      ...
      >
        ...
        >
          <DeletionApprover
            ...
            ordersOnPageLength={ordersOnPageLength}
          />
        </Dropdown>
      </div>

      <div className={styles.block}>
        <Pagination ordersLength={filteredOrdersLength} />
      </div>
    </TableFooter>
  );
}
